...
download_azurlane () {
    ...
    # 渠道服全都不是直链,不知道怎么搞了
    url="https://pkg.biligame.com/games/blhx_6.2.1_bilibili_20221107_143634.apk*wpLCng==afae37c2a88fd1ca&sh=10&sf=1831727323&vh=18330f93bd450707942ce0b882a0c6b2&cc=2521889677&did=217b729f8a4841dd81901816dfba551f"
    # 使用wget命令下载apk文件
    curl -o blhx.apk  $url
    fi
}
